# RETIRED FOLDER — investment_theses/
...
**Audit snapshot:** `archive/2026-04-15_pre_restructure/investment_theses/` — full contents preserved there pre-restructure.

**Do not write here.** Any scheduled task or script that references this path is a regression. The hub self-audit greps for the bare name (`investment_theses/`) in run logs and aborts on hit.
