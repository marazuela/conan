# RETIRED FOLDER — performance_reports/
...
**Audit snapshot:** `archive/2026-04-15_pre_restructure/performance_reports/` — full contents preserved there pre-restructure.

**Do not write here.** Any scheduled task or script that references this path is a regression. The hub self-audit greps for the bare name (`performance_reports/`) in run logs and aborts on hit.
