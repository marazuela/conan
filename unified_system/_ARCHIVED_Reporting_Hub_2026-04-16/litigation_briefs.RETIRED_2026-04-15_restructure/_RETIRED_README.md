# RETIRED FOLDER — litigation_briefs/
...
**Audit snapshot:** `archive/2026-04-15_pre_restructure/litigation_briefs/` — full contents preserved there pre-restructure.

**Do not write here.** Any scheduled task or script that references this path is a regression. The hub self-audit greps for the bare name (`litigation_briefs/`) in run logs and aborts on hit.
