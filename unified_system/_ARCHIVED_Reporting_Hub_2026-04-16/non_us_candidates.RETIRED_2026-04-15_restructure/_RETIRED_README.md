# RETIRED FOLDER — non_us_candidates/
...
**Audit snapshot:** `archive/2026-04-15_pre_restructure/non_us_candidates/` — full contents preserved there pre-restructure.

**Do not write here.** Any scheduled task or script that references this path is a regression. The hub self-audit greps for the bare name (`non_us_candidates/`) in run logs and aborts on hit.
